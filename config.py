...
LANG_LABELS = load_env_or_default("LANG_LABELS", "R,java,julia,ruby,nodejs,python,c-cpp,perl,rust,python-c,go")
...
LANG_LABELS: set[str] = {l.strip() for l in LANG_LABELS.split(",")}
